...
if web3.isConnected():
    ...
    targetAccount = web3.toChecksumAddress(
        "0xac4FafdA6A3A6B48b4cDC2a896acf8D104C81d6C")
    ...
    print("about to transfer " + str(transferValue/decimals) +
          " " + symbol() + " to " + targetAccount)
